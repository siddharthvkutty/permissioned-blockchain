...
verify authenticity with the sender's public key. Under PoA, a
validator's block-proposal signature uses this exact same keypair - a
validator doesn't need a second, separate identity to propose blocks,
just their ordinary wallet key.
